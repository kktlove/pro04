...
CREATE TABLE Usertbl(
    ...
    username VARCHAR(100) NOT NULL, email VARCHAR(250),
    password VARCHAR(500), address VARCHAR(300), phone VARCHAR(50), 
    website VARCHAR(100), company VARCHAR(100)
);
```


## 2) kr.ed.haebeop.domain.UserVo.java 클래스 작성
...
## 3) kr.ed.haebeop.persistence.UserMapper.java 인터페이스 작성
...
## 4) kr.ed.haebeop.service.UserService.java 인터페이스 작성
...
## 5) kr.ed.haebeop.controller.UserController.java 클래스 작성
...
## 6) /webapp/WEB-INF/views/include/hd.jsp 작성
...
## 7) /webapp/WEB-INF/views/include/ft.jsp 작성
...
<!-- 푸터 내용 기술 -->
<footer class="callout large secondary" id="ft">
...
## 8) /webapp/WEB-INF/views/include/head.jsp 작성
...
## 9) /webapp/WEB-INF/views/member/agree.jsp 작성
...
<div class="container is-fullhd">
    ...
    <nav aria-label="You are here:" role="navigation">
        <ul class="breadcrumbs">
            ...
            <li>
                <span class="show-for-sr">Current: </span> Agree
            </li>
        </ul>
    </nav>
...
## 10) /webapp/WEB-INF/views/member/loginForm.jsp 작성
    ...
    <div class="content" id="contents">
        <div class="row column text-center">
            ...
            <div class="container">
                ...
                <form action="${path1}/auth" method="post" name="loginForm">
                    ...
                    <div class="table_form_wrap">
                        <table class="table_form">
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="text" name="email" id="email" size="100" class="input" placeholder="아이디 입력" required>
                                    <!--  pattern="^[a-z0-9]+$"  -->
                                </td>
                            </tr>
                            <tr>
                                <th><label for="password">비밀번호</label></th>
                                <td><input type="password" name="password" id="password"  class="input" placeholder="비밀번호 입력" required>
                                    <!--  pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}"  -->
                                </td>
                            </tr>
                            <tr>
                                <td colspan="2">
                                    <input type="submit" class="button success submit" value="로그인">
                                    <button type="button" onclick="location.href='${path1}/signup'" class="button alert">회원가입</button>
                                </td>
                            </tr>
                            </tbody>
                        </table>
...
## 11) /webapp/WEB-INF/views/member/memberDetail.jsp 작성
...
## 12) /webapp/WEB-INF/views/member/memberInsert.jsp 작성
            ...
            <form name="frm1" id="frm1" action="${path1 }/member/insert.do" method="post" onsubmit="return joinCheck(this)">
                ...
                <table id="table1">
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="email" name="email" id="email" placeholder="이메일 입력" pattern="^\w+((\.\w+)?)+@\w+.?\w+\.\w+$" maxlength="80" required style="width:700px; float:left;">
                            <input type="button" id="idCkBtn" class="button" value="이메일 중복 체크" onclick="idCheck()">
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="password" name="password" id="password" placeholder="비밀번호 입력" maxlength="12" required>
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="password" name="password2" id="password2" placeholder="비밀번호 확인 입력" maxlength="12" required>
                            <!-- pattern="^(?=.*[A-Za-z])(?=.*\d)(?=.*[$@$!%*#?&])[A-Za-z\d$@$!%*#?&]{8,12}$"  -->
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <input type="text" name="name" id="name" placeholder="아이디 입력" maxlength="40" required>
                            <!-- pattern="^(?=.*[A-Za-z])(?=.*\d)(?=.*[$@$!%*#?&])[A-Za-z\d$@$!%*#?&]{8,12}$"  -->
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <input type="text" name="username" id="username" placeholder="이름 입력" maxlength="40" required>
                        </td>
                    </tr>
                    <tr>
                        <th style="background-color:#dcdcdc">전화번호</th>
                        <td>
                            <input type="tel" name="phone" id="phone" placeholder="전화번호 입력" pattern="[0-9]{2,3}-[0-9]{3,4}-[0-9]{3,4}" maxlength="19" required>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <th style="background-color:#dcdcdc">웹 사이트 주소</th>
                        <td>
                            <input type="url" name="website" id="website" placeholder="웹사이트 주소 입력">
                        </td>
                    </tr>
                    <tr>
                        <th style="background-color:#dcdcdc">회사명</th>
                        <td>
            ...
            <script>
                $(document).ready(function(){
                    $("#email").keyup(function(){
                        $("#idck").val("no");
                        if($(this).val()!=""){
                            $("#msg").html("<strong>이메일을 입력중입니다.</strong>");
                        } else {
                            $("#msg").html("아직 이메일 중복 체크를 하지 않으셨습니다.");
                        }
                    });
                });
            </script>
                    ...
                    $.ajax({
                        ...
                        success:function(result){
                            ...
                            if(idChk==false){	//사용할 수 없는 아이디
                                $("#idck").val("no");
                                $("#msg").html("<strong style='color:red'>기존에 사용되고 있는 이메일 입니다. 다시 입력하시기 바랍니다.</strong>");
                                $("#email").focus();
                            } else if(idChk==true){	//사용 가능한 아이디
                                $("#idck").val("yes");
                                $("#msg").html("<strong style='color:blue'>사용가능한 이메일 입니다.</strong>");
                            } else if(idck==""){
                                $("#msg").html("<strong>이메일이 확인되지 않았습니다. 다시 시도해주시기 바랍니다.</strong>");
                            }
                        }
                    });
                }
                function joinCheck(f){
                    f.address.value = f.addr1.value + "<br>" + f.addr2.value + "<br>" + f.postcode.value;
                    if(f.psssword.value!=f.psssword2.value){
                        alert("비밀번호와 비밀번호 확인이 서로 다릅니다.");
                        f.psssword.focus();
                        return false;
                    }
...
## 13) /webapp/WEB-INF/views/member/memberList.jsp 작성
...
## 14) /webapp/WEB-INF/views/member/mypage.jsp 작성
...
## 15) /webapp/WEB-INF/views/member/memberUpdate.jsp 작성
...
<div class="container is-fullhd">
    ...
    <div class="content" id="contents">
        <div class="row column text-center">
            ...
            <hr>
            <div class="container">
                <form name="frm1" id="frm1" action="${path1 }/update" method="post" onsubmit="return joinCheck(this)">
                    <input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}" />
                    <table id="table1">
                        <tbody>
                        <tr>
                            <th style="background-color:#dcdcdc">이메일</th>
                            <td>
                                <input type="email" name="email" id="email" placeholder="이메일 입력" value="${user.emil}" readonly style="width:700px; float:left;">
                            </td>
                        </tr>
                        <tr>
                            <th style="background-color:#dcdcdc">비밀번호</th>
                        ...
                        <tr>
                            <th style="background-color:#dcdcdc">아이디</th>
                            <td>
                                <input type="text" name="name" id="name" value="${user.name}" placeholder="아이디 입력" maxlength="40" readonly>
                                <!-- pattern="^(?=.*[A-Za-z])(?=.*\d)(?=.*[$@$!%*#?&])[A-Za-z\d$@$!%*#?&]{8,12}$"  -->
                            </td>
                        </tr>
                        <tr>
                            <th style="background-color:#dcdcdc">이름</th>
                            <td>
                                <input type="text" name="username" id="username" value="${user.username}" placeholder="이름 입력" maxlength="40" required>
                            </td>
                        </tr>
                        <tr>
                            <th style="background-color:#dcdcdc">전화번호</th>
                            <td>
                                <input type="tel" name="phone" id="phone" value="${user.phone}" placeholder="전화번호 입력" pattern="[0-9]{2,3}-[0-9]{3,4}-[0-9]{3,4}" maxlength="19" required>
                            </td>
                        </tr>
                        <tr>
                            <th style="background-color:#dcdcdc">주소</th>
                            <td>
                                <p>${user.address}</p>
                                <input type="text" name="addr1" id="addr1" placeholder="기본주소 입력" maxlength="150"><br><br>
                                <input type="text" name="addr2" id="addr2" placeholder="상세주소 입력" maxlength="90"><br><br>
                                <input type="text" name="postcode" id="postcode" placeholder="우편번호 입력" maxlength="9">
                        ...
                        <tr>
                            <th style="background-color:#dcdcdc">웹 사이트 주소</th>
                            <td>
                                <input type="url" name="website" id="website" value="${user.website}" placeholder="웹사이트 주소 입력">
                            </td>
                        </tr>
                        <tr>
                            <th style="background-color:#dcdcdc">회사명</th>
                            <td>
                                <input type="text" name="company" id="company" value="${user.company}" placeholder="회사명 입력">
                            </td>
                        </tr>
                        <tr>
                            <td colspan="2">
