    ...
    <div class="contents">
        <nav aria-label="You are here:" role="navigation">
            <ul class="breadcrumbs">
                ...
                <li>
                    <span class="show-for-sr">Current: </span> FileBoard Update
                </li>
            </ul>
        </nav>
        <form action="${path1}/fileboard/update.do" method="post" enctype="multipart/form-data">
            <h2 class="title">자료실 글 수정</h2>
            <hr>
                        ...
                        <td>
                            <ul class="list">
                                <c:forEach var="file" items="${attachList}">
                                    <li><a href="${path1}${file.uploadpath}/${file.uuid}/${file.filename}" download>${file.filename}</a></li>
                                </c:forEach>
                            </ul>
            ...
            <ul class="button-group" style="list-style:none;width:270px;margin:10px auto;">
                <li><a href="${path1}/fileboard/list.do?curpage=1" class="button">글 목록</a></li>
                <c:if test="${sid.equals('admin') or sid.equals(board.author)}">
                    <li><input type="submit" class="button" value="글 수정"></li>
                    <li><a href="${path1 }/fileboard/delete.do?num=${board.num}" class="button">글 삭제</a></li>
                </c:if>
            </ul>
        </form>
    </div>
