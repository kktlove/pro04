...
<div class="container is-fullhd">
    ...
    <div class="contents">
        ...
        <form action="${path1}/free/update.do" method="post">
            <h2 class="title">글 수정</h2>
            <hr>
            <table class="inner-table" style="min-width:960px;">
                <tbody>
                    <tr>
                        <th>글 번호</th>
                        <td>
                    ...
                    <tr>
                        <th>글 제목</th>
                        <td><input type="text" id="title" name="title" value="${free.title}" required>
                            <c:if test="${not empty msg}">
                                <p style="color:deeppink;font-weight: bold">${msg}</p>
                            </c:if>
                        </td>
                    </tr>
                    <tr>
                        <th>글 내용</th>
                        <td>
                            <textarea id="content" name="content" required>${free.content}</textarea>
                            <script>
