...
<div class="container is-fullhd">
    ...
    <div class="contents">
        ...
        <form action="${path1}/book/write.do" method="post" enctype="multipart/form-data">
            <h2 class="title">교재 등록하기</h2>
            <hr>
            <table class="inner-table">
                <tbody>
                    ...
                    <tr>
                        <th>교재 목차</th>
                        <td>
                            <textarea id="blist" name="blist" required></textarea>
                        </td>
                    </tr>
                    <tr>
                        <th>교재 내용</th>
                        <td>
                            <textarea id="bcoment" name="bcoment" required></textarea>
                        </td>
                    </tr>
                    <tr>
                        <th>출판사</th>
                        <td>
                            <input type="text" id="pubcom" name="pubcom" required>
                        </td>
                    </tr>
                    <tr>
                        <th>출판일</th>
                    ...
                    <tr>
                        <th>가격</th>
                        <td>
                            <input type="number" min="1000" max="100000" step="100" id="price" name="price" required>
                        </td>
                    </tr>
                    <tr>
                        <th>교재 이미지</th>
                        <td>
                            앞 표지 : <input type="file" id="fcover" name="files" accept="image/*" required><br>
                            뒤 표지 : <input type="file" id="bcover" name="files" accept="image/*" required><br>
                            내지 : <input type="file" id="bpic" name="files" accept="image/*" required>
                        </td>
                    </tr>
                    <tr>
                        <th>교재 자료</th>
                        <td>
                            <input type="file" id="pfile" name="files" accept=".pdf" required><br>
                        </td>
                    </tr>
                    <tr>
                        <th>참고사항</th>
            ...
            <ul class="button-group" style="list-style:none;width:360px;margin:10px auto;">
                <li><a href="${path1}/book/list.do?curpage=1" class="button">교재 목록</a></li>
                <c:if test="${sid.equals('admin')}">
                    <li><input type="submit" class="button" value="교재 등록"></li>
                </c:if>
            </ul>
        </form>
    </div>
