    ...
    <div class="contents">
        <nav aria-label="You are here:" role="navigation">
            <ul class="breadcrumbs">
                ...
                <li><a href="#">Book</a></li>
                <li>
                    <span class="show-for-sr">Current: </span> Book Inventory
                </li>
            </ul>
        </nav>
        <form action="${path1}/book/addInventory.do" method="post" enctype="multipart/form-data">
            <h2 class="title">교재 입고하기</h2>
            <hr>
            <table class="inner-table">
                <tbody>
                    ...
                    <tr>
                        <th>수량</th>
                        <td>
                            <input type="number" min="1" max="100" step="1" id="amount" name="amount" required>
                        </td>
                    </tr>
                </tbody>
            </table>
            <ul class="button-group" style="list-style:none;width:180px;margin:10px auto;">
                ...
                <c:if test="${sid.equals('admin')}">
                    <li><input type="submit" class="button" value="교재 입고"></li>
                </c:if>
            </ul>
        </form>
    </div>
