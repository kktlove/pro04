    ...
    <nav class="top-bar">
        ...
        <ul class="dropdown menu align-center" data-dropdown-menu>
            ...
            <li>
                ...
                <ul class="menu">
                    <li><a href="${path1 }/board/list.do?curpage=1" class="navbar-item">공지사항</a></li>
                    <li><a href="${path1 }/free/list.do?curpage=1" class="navbar-item">자유게시판</a></li>
                    <c:if test="${not empty sid}">
                    <li><a href="${path1 }/socket" class="navbar-item">Chat</a></li>
                    </c:if>
                    <li><a href="${path1 }/fileboard/list.do?curpage=1" class="navbar-item">자료실</a></li>
                    <li><a href="${path1 }/book/list.do?curpage=1" class="navbar-item">교재 목록</a></li>
                    <c:if test="${sid.equals('admin')}">
                        <li><a href="#" class="navbar-item">FileUpload</a></li>
                        <li><a href="${path1}/book/write.do" class="navbar-item">교재 등록</a></li>
                        <li><a href="${path1}/book/addInventory.do" class="navbar-item">교재 입고</a></li>
                    </c:if>
